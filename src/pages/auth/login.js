...
// RAISON: Implémentation de la page de connexion utilisateur
// DÉPENDANCES: components/Header.js, components/Footer.js (via _app.js)
// ÉTAT PRÉCÉDENT: Page d'accueil opérationnelle
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Dans une version future, appel à l'API d'authentification
      console.log('Tentative de connexion avec:', { email });
      
      // Simuler un délai pour la démo
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      // Redirection future vers le tableau de bord
      alert('Connexion simulée pour la démo');
    } catch (err) {
  ...
  return (
    <>
      <Head>
        <title>Connexion | InnoHub Africa</title>
        <meta name="description" content="Connectez-vous à votre compte InnoHub Africa" />
      </Head>
      <div className="py-12 sm:py-16 lg:py-20 bg-gray-50">
        <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-800">Connexion</h1>
            <p className="text-gray-600 mt-2">Accédez à votre compte pour participer à la communauté</p>
          </div>
